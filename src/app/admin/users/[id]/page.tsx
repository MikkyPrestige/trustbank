...
// import { CreditCard, Activity, User, MapPin, HeartHandshake, History, Wallet, ArrowLeft, ArrowRightLeft, ShieldCheck, Lock } from "lucide-react";
// import { requireAdmin } from "@/lib/auth/admin-auth";
// import Link from "next/link";
// import { notFound } from "next/navigation";
// import styles from "../../../../components/admin/users/[id]/users.module.css"
...
//             type: l.level === 'WARNING' ? 'WARNING' : l.level === 'CRITICAL' ? 'CRITICAL' : 'INFO',
//             title: l.action.replace(/_/g, ' '),
//             message: `${l.metadata || 'Security Event detected'} (IP: ${l.ipAddress || 'Unknown'})`,
//             createdAt: l.createdAt,
//             icon: 'shield'
//         }))
//     ].sort((a, b) => b.createdAt.getTime() - a.createdAt.getTime());
...
//                         </span>
//                         {isLocked && (
//                             <span className={styles.badge} style={{ background: '#fecaca', color: '#dc2626', border: '1px solid #ef4444', display: 'flex', gap: '4px', alignItems: 'center' }}>
//                                 <Lock size={10} /> LOCKED
//                             </span>
//                         )}
//                     </div>
...
//                     <div className={styles.section}>
//                         <h3 className={styles.secTitle}>
//                             <ShieldCheck size={18} /> Security & Activity Log
//                         </h3>
//                         <ActivityLog logs={user.Notification} />
//                     </div>
...
//                                 <input disabled defaultValue={user.address || 'N/A'} className={styles.input} />
//                             </div>

//                             <div className={styles.field}>
//                                 <label>City</label>
//                                 <input disabled defaultValue={user.city || 'N/A'} className={styles.input} />
//                             </div>
//                             <div className={styles.field}>
//                                 <label>State / Province</label>
//                                 <input disabled defaultValue={user.state || 'N/A'} className={styles.input} />
//                             </div>
//                             <div className={styles.field}>
//                                 <label>Zip Code</label>
//                                 <input disabled defaultValue={user.zipCode || 'N/A'} className={styles.input} />
//                             </div>
//                             <div className={styles.field}>
//                                 <label>Country</label>
//                                 <input disabled defaultValue={user.country || 'N/A'} className={styles.input} />
//                             </div>
//                         </div>
...
//     const isLocked = !!(user.pinLockedUntil && new Date() < user.pinLockedUntil);
...
//                     <p className={styles.subtitle}>Joined: {formatDate(user.createdAt)}</p>
//                 </div>
//                 <UserActions userId={user.id} status={user.status} siteName={settings.site_name} isLocked={isLocked} />
//             </header>
