...
// --- TYPES: Define strict types for your menu ---
interface SubLink {
    label: string;
    href: string;
}
...
interface MegaMenuSection {
    title: string;
    links: SubLink[][]; // Array of columns, each column is an array of SubLinks
    promo: PromoConfig;
}
...
export default function Navbar() {
    ...
    // ✅ IMPROVED HOVER LOGIC: Adds a delay before closing so it doesn't snap shut
