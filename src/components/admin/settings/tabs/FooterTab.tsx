    ...
    return (
        <div className={styles.grid}>
            ...
            <div className={styles.group}>
                ...
                <input name="footer_lbl_support" defaultValue={settings.footer_lbl_support} className={styles.input} />
            </div>
            <div className={styles.group}>
                <label className={styles.label}>Email Label</label>
                <input name="footer_lbl_email" defaultValue={settings.footer_lbl_email} className={styles.input} />
            </div>
            <div className={styles.group}>
                <label className={styles.label}>Hours Label</label>
                <input name="footer_lbl_hours" defaultValue={settings.footer_lbl_hours} className={styles.input} />
            </div>
            <div className={styles.group}>
                <label className={styles.label}>Hours Value</label>
                <input name="footer_val_hours" defaultValue={settings.footer_val_hours} className={styles.input} />
            </div>
            <div className={styles.group}>
                <label className={styles.label}>Video Label</label>
                <input name="footer_lbl_video" defaultValue={settings.footer_lbl_video} className={styles.input} />
            </div>
            <div className={styles.group}>
                <label className={styles.label}>Video Value</label>
            ...
            <div className={styles.group}>
                <label className={styles.label}>No Link</label>
                <input name="footer_noLink" defaultValue={settings.footer_noLink} className={styles.input} />
            </div>
            ...
            <div className={styles.group}>
                <label className={styles.label}>Header 2</label>
            ...
            <div className={styles.group}>
                ...
                <input name="footer_lbl_copyright" defaultValue={settings.footer_lbl_copyright} className={styles.input} />
            </div>
            <div className={styles.group}>
                <label className={styles.label}>Button Text</label>
                <input name="footer_lbl_locate" defaultValue={settings.footer_lbl_locate} className={styles.input} />
            </div>
            <div className={styles.group}>
            ...
            <div className={styles.group}>
                ...
                <input name="footer_badge2" defaultValue={settings.footer_badge2} className={styles.input} />
            </div>
            <div className={styles.group}>
                <label className={styles.label}>3</label>
                <input name="footer_badge3" defaultValue={settings.footer_badge3} className={styles.input} />
            </div>
            <div className={styles.group}>
            ...
            <div className={styles.group}>
                <label className={styles.label}><Facebook size={14} /> Facebook URL</label>
                <input name="social_facebook" defaultValue={settings.social_facebook} className={styles.input} />
            </div>
            <div className={styles.group}>
                <label className={styles.label}><Twitter size={14} /> Twitter/X URL</label>
                <input name="social_twitter" defaultValue={settings.social_twitter} className={styles.input} />
            </div>
            <div className={styles.group}>
                <label className={styles.label}><Linkedin size={14} /> LinkedIn URL</label>
                <input name="social_linkedin" defaultValue={settings.social_linkedin} className={styles.input} />
            </div>
            <div className={styles.group}>
                <label className={styles.label}><Instagram size={14} /> Instagram URL</label>
                <input name="social_instagram" defaultValue={settings.social_instagram} className={styles.input} />
            </div>
        </div>
    );
}