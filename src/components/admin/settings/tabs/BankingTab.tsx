    ...
    return (
        <div className={styles.grid}>
            ...
            <div className={styles.fullWidth}>
                <h3 className={styles.sectionTitle}>Bank Page Config</h3>
            </div>
            ...
            <div className={styles.group}>
                ...
                <input name="bank_hero_alt" defaultValue={settings.bank_hero_alt} className={styles.input} />
            </div>
            ...
            <div className={styles.fullWidth}>
                <h3 className={styles.sectionTitle}>3D Card Visuals</h3>
            </div>
            ...
            <div className={styles.fullWidth}>
                <hr className={styles.divider} />
                <h3 className={styles.sectionTitle}>Product Sections Config</h3>
            </div>
            {/* Checking & Savings */}
            <div className={styles.fullWidth}>
                <h4 className={styles.subsectionTitle}>1. Checking & Savings</h4>
            </div>
            <div className={`${styles.group} ${styles.fullWidth}`}>
            ...
            <div className={styles.group}>
                <label className={styles.label}>Image Alt Text</label>
                <input name="bank_cs_img_alt" defaultValue={settings.bank_cs_img_alt} className={styles.input} />
            </div>
            <div className={`${styles.group} ${styles.fullWidth}`}>
                <label className={styles.label}>Description</label>
                <input name="bank_cs_desc" defaultValue={settings.bank_cs_desc} className={styles.input} />
            </div>
            <div className={styles.group}>
            ...
            {/* Business Banking */}
            <div className={styles.fullWidth}>
                <h4 className={styles.subsectionTitle}>2. Business Banking</h4>
            </div>
            <div className={`${styles.group} ${styles.fullWidth}`}>
                <label className={styles.label}>Title</label>
            ...
            <div className={styles.group}>
                <label className={styles.label}>Image Alt Text</label>
                <input name="bank_biz_img_alt" defaultValue={settings.bank_biz_img_alt} className={styles.input} />
            </div>
            <div className={`${styles.group} ${styles.fullWidth}`}>
                <label className={styles.label}>Description</label>
                <input name="bank_biz_desc" defaultValue={settings.bank_biz_desc} className={styles.input} />
            </div>
            <div className={styles.group}>
                <label className={styles.label}>Anchor Text</label>
            ...
            {/* Student Banking */}
            <div className={styles.fullWidth}>
                <h4 className={styles.subsectionTitle}>3. Student Banking</h4>
            </div>
            <div className={`${styles.group} ${styles.fullWidth}`}>
                <label className={styles.label}>Title</label>
            ...
            <div className={styles.group}>
                <label className={styles.label}>Image Alt Text</label>
                <input name="bank_stu_img_alt" defaultValue={settings.bank_stu_img_alt} className={styles.input} />
            </div>
            <div className={`${styles.group} ${styles.fullWidth}`}>
                <label className={styles.label}>Description</label>
                <input name="bank_stu_desc" defaultValue={settings.bank_stu_desc} className={styles.input} />
            </div>
            <div className={styles.group}>
                <label className={styles.label}>Anchor Text</label>
            ...
            <div className={styles.fullWidth}><h4 className={styles.subsectionTitle}>Feature 1</h4></div>
            <div className={styles.group}>
                <label className={styles.label}>Title</label>
            ...
            <div className={styles.fullWidth}><h4 className={styles.subsectionTitle}>Feature 2</h4></div>
            <div className={styles.group}>
                <label className={styles.label}>Title</label>
            ...
            <div className={styles.fullWidth}><h4 className={styles.subsectionTitle}>Feature 3</h4></div>
            <div className={styles.group}>
                <label className={styles.label}>Title</label>
            ...
            <div className={styles.fullWidth}><h4 className={styles.subsectionTitle}>Table</h4></div>
            <div className={styles.group}>
            ...
            {/* Row 1 */}
            <div className={styles.fullWidth}>
                <h4 className={styles.subsectionTitle}>Row 1: Maintenance</h4>
            </div>
            <div className={styles.group}>
            ...
            {/* Row 2 */}
            <div className={styles.fullWidth}>
                <h4 className={styles.subsectionTitle}>Row 2: Overdraft</h4>
            </div>
            <div className={styles.group}>
                <label className={styles.label}>Label</label>
            ...
            {/* Row 3 */}
            <div className={styles.fullWidth}>
                <h4 className={styles.subsectionTitle}>Row 3: Foreign Tx</h4>
            </div>
            <div className={styles.group}>
                <label className={styles.label}>Label</label>
            ...
            {/* Row 4 */}
            <div className={styles.fullWidth}>
                <h4 className={styles.subsectionTitle}>Row 4: Min Balance</h4>
            </div>
            <div className={styles.group}>
                <label className={styles.label}>Label</label>
            ...
            {/* Row 5 */}
            <div className={styles.fullWidth}>
                <h4 className={styles.subsectionTitle}>Row 5: Direct Deposit</h4>
            </div>
            <div className={styles.group}>
                <label className={styles.label}>Label</label>
