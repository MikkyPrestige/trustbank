                        ...
                        {showRejectInput ? (
                            <div className={styles.rejectForm}>
                                <input
                                    ...
                                    autoFocus
                                />
                                <button onClick={handleReject} disabled={loading} className={styles.confirmRejectBtn}>
                                    {loading ? <Loader2 className={styles.spin} size={12} /> : "Confirm"}
                                </button>
                                <button onClick={() => setShowRejectInput(false)} className={styles.cancelBtn}>
                                    <X size={14} />
                                </button>
                            </div>
                        ) : (
                    ...
                    <td colSpan={5}>
                        <div className={styles.docGrid}>
                            ...
                            <div className={styles.docItem}>
                                ...
                                <a href={user.passportUrl || '#'} target="_blank" className={styles.link}>Open Full Size</a>
                            </div>
                            ...
                            <div className={styles.docItem}>
                                ...
                                <a href={user.idCardUrl || '#'} target="_blank" className={styles.link}>Open Full Size</a>
                            </div>
